...
def get_data(root_path, dataType):
    map_dict = { "SCUT":'SCUT-FBP5500_v2', "HandWrite":'HandWrite',
                 "EdgeAOI":'EdgeAOI'}
    VOCdevkit_path = os.path.join(root_path, map_dict[dataType])

    annotation_path = os.path.join(VOCdevkit_path, "Classification/cls_train.txt")

    #------------------------------------------------------#
    #   獲取classes
    #------------------------------------------------------#
    classes_path    = f'model_data/{dataType}_classes.txt'
