...
class Trainer:
    def __init__(self, opt):          
        ...
        crietion = models.init_loss(opt.loss_type)
        # ------------------------------------------------------------------------------- 
        if local_rank == 0:           
    ...
    def train(self):
        ...
        for epoch in range(self.opt.Init_Epoch, self.opt.UnFreeze_Epoch):
            ...
            self.fit_one_epoch(self.model_train, self.model, self.crietion, self.loss_history, self.optimizer, epoch, \
