...
class BasicConv2d(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, **kwargs: Any):
        ...
        # self.conv = nn.Conv2d(in_channels, out_channels, bias=False, kernel_size=3, stride=2)
        # self.conv = nn.Conv2d(in_channels, out_channels, bias=False, kernel_size=3, stride=1)
...
def inception_v3(pretrained = False, progress = True, num_classes=1000):
